...
import {Entry, EntryBlock, Picture, PictureSquareSet, EntryHeader, Title, EntryText, EntryVideo} from './entry';
...
export class EntriesService {
    ...
    public entryBlocks: EntryBlock[] = [
        ...
        new PictureSquareSet(
            [
                new Picture({picture: "./mammothSet/7K2A5537"}),
                new Picture({picture: "./mammothSet/7K2A5545"})
            ],
        ...
        new Picture({title: "", picture: "./mammothSet/7K2A5556"}),
        new PictureSquareSet(
            [
                new Picture({picture: "./mammothSet/7K2A5566"}),
                new Picture({picture: "./mammothSet/7K2A5573"})
            ],
            '',
            false,
            true
        ),
        new Picture({title: "", picture: "./mammothSet/7K2A5779"}),
        new Picture({title: "", picture: "./mammothSet/7K2A6172"}),
        new EntryText("Day 2."),
        new Picture({title: "", picture: "./mammothSet/7K2A6174"}),
        new PictureSquareSet(
            [
                new Picture({picture: "./mammothSet/7K2A6178"}),
                new Picture({picture: "./mammothSet/7K2A6189"}),
                new Picture({picture: "./mammothSet/7K2A6223"}),
                new Picture({picture: "./mammothSet/7K2A6211"})
            ],
        ...
        new Picture({title: "", picture: "./mammothSet/7K2A6224", note: "The further we go up the more you could see how massive the mountains were compared to the small 4wd road paved out on the side of the mountain. Feeling like the size of ant in these parts was refreshing yet worrisome knowing how far you'd fall if you didn't stick to the road."}),
        new Picture({title: "", picture: "./mammothSet/7K2A6244"}),
        new Picture({title: "", picture: "./mammothSet/7K2A6263", note: "The road near the area where a rockslide had happened proved to be anything but easy or stable. Constant movement from the traction of the tires on the loose rocks pushed rocks down on both sides of the road. We wanted to get out of the rockslide area as fast as we could."}),
        new Picture({title: "", picture: "./mammothSet/7K2A6292", note: "Following the rockslide area was a series of switchbacks going up and down not really knowing when We'd reach the top. When we finally did and saw what we had climbed up, it seemed almost insane that such a road could be carved up the face of these mountains."}),
        new Picture({title: "", picture: "./mammothSet/7K2A6300", note: "Having gotten to the top we took a step out to see where we had gotten. Rain thunder and wind welcomed us at our top height of 10,300 feet. Luckly this time however I brought some ibuprofen along for the ride to ease the effects of altitude sickness."}),
        new Picture({title: "", picture: "./mammothSet/7K2A6302", note: "Bringing a jacket definately was a choice well made."}),
        new Picture({title: "", picture: "./mammothSet/7K2A6333"}),
        new PictureSquareSet(
            [
                new Picture({picture: "./mammothSet/7K2A6357"}),
                new Picture({picture: "./mammothSet/7K2A6360"}),
                new Picture({picture: "./mammothSet/7K2A6372"}),
                new Picture({picture: "./mammothSet/7K2A6370"})
            ],
        ...
        new Picture({title: "", picture: "./mammothSet/7K2A6373", note: "Trying to decide on the turn or pulling on forward for our chances with the cliff."}),

        new Picture({title: "", picture: "./mammothSet/7K2A6378", note: "After 30 minutes of trying to guide eachother. We managed to pull off flipping the car around and setting it near the cliff. Realizing how hard it was to just turn it around, we decided on leaving it on top for the night and making the rest of the trip on foot to the bottom of laurel lakes. Two trips were made back up to the car to get the gear for the night."}),
        new Picture({title: "", picture: "./mammothSet/7K2A6399"}),
        new EntryVideo("./mammothSet/7K2A6459"),


        new PictureSquareSet(
            [
                new Picture({picture: "./mammothSet/7K2A6401"}),
                new Picture({picture: "./mammothSet/7K2A6512"})
            ],
            null,
            false,
            true
        ...
        new PictureSquareSet(
            [
                new Picture({picture: "./mammothSet/7K2A6527"}),
                new Picture({picture: "./mammothSet/7K2A6493"})
            ],
            null,
            false,
            true
        ),
        new EntryVideo("./mammothSet/7K2A6533"),
        new Picture({picture: "./mammothSet/7K2A6770"}),
    ...
    public entryHeader: EntryHeader = new EntryHeader(
        new Picture({picture: "./mammothSet/7K2A5450"}),
    ...
    getEntry(id: number): Promise<Entry> {
       var entry = this.entries.filter(entry => entry.id == id)[0]
