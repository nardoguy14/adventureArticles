...
(function (MammothEntry) {
    ...
    var entryBlocks = [
        ...
        new entry_1.PictureSquareSet([
            new entry_1.Picture({ picture: dir + "7K2A5537" }),
            new entry_1.Picture({ picture: dir + "7K2A5545" })
        ...
        new entry_1.Picture({ title: "", picture: dir + "7K2A5556" }),
        new entry_1.PictureSquareSet([
            new entry_1.Picture({ picture: dir + "7K2A5566" }),
            new entry_1.Picture({ picture: dir + "7K2A5573" })
        ], '', false, true),
        new entry_1.Picture({ title: "", picture: dir + "7K2A5779" }),
        new entry_1.Picture({ title: "", picture: dir + "7K2A6172" }),
        new entry_1.EntryText("Day 2."),
        new entry_1.Picture({ title: "", picture: dir + "7K2A6174" }),
        new entry_1.PictureSquareSet([
            new entry_1.Picture({ picture: dir + "7K2A6178" }),
            new entry_1.Picture({ picture: dir + "7K2A6189" }),
            new entry_1.Picture({ picture: dir + "7K2A6223" }),
            new entry_1.Picture({ picture: dir + "7K2A6211" })
        ...
        new entry_1.Picture({ title: "", picture: dir + "7K2A6244" }),
        new entry_1.Picture({
            title: "",
        ...
        new entry_1.Picture({ title: "", picture: dir + "7K2A6333" }),
        new entry_1.PictureSquareSet([
            new entry_1.Picture({ picture: dir + "7K2A6357" }),
            new entry_1.Picture({ picture: dir + "7K2A6360" }),
            new entry_1.Picture({ picture: dir + "7K2A6372" }),
            new entry_1.Picture({ picture: dir + "7K2A6370" })
        ...
        new entry_1.EntryVideo(dir + "7K2A6441"),
        new entry_1.Picture({
            title: "",
        ...
        new entry_1.Picture({ title: "", picture: dir + "7K2A6399" }),
        new entry_1.EntryVideo(dir + "7K2A6459"),
        new entry_1.PictureSquareSet([
            new entry_1.Picture({ picture: dir + "7K2A6401" }),
            new entry_1.Picture({ picture: dir + "7K2A6512" })
        ], null, false, true),
        new entry_1.PictureSquareSet([
            new entry_1.Picture({ picture: dir + "7K2A6527" }),
            new entry_1.Picture({ picture: dir + "7K2A6493" })
        ], null, false, true),
        new entry_1.EntryVideo(dir + "7K2A6533"),
        new entry_1.Picture({ picture: dir + "7K2A6770" }),
        new entry_1.EntryText("Day 3.", ["Like all trips, the last day is always spent trekking back the hundreds of miles back home. We couldn't help but stop by Bodie given that it was only 10 miles east off the road back home. Known as a ghost town, the 4th of the July weekend made it almost impossible to take a photo of a building not surrounded by people already. Yet like all towns, the outskirts tend to be much more isolated. Having gotten a nice rest here we left back home."])
    ];
    var entryHeader = new entry_1.EntryHeader(new entry_1.Picture({ picture: dir + "7K2A5450" }), new entry_1.Title("A", "HOLIDAY IN THE MOUNTAINS ", "by Nardo + Kevin"), "Fourth of July weekend usually means lots of people, packed streets, packed parking lots, bbq, and last but def. not least fireworks. For once though we wanted to take the opportunity to do something else for a change. Having never taken out the Taco ( Tacoma ) for off roading, we headed out to Mammoth for 3 days off camping and trails for the new truck.  Word to the wise, it's much better to plan camping spots months in advance.");
    function getEntry() {
        return new entry_1.EntryArticle(entryHeader, entryBlocks);
    }
    MammothEntry.getEntry = getEntry;
})(MammothEntry = exports.MammothEntry || (exports.MammothEntry = {}));
//# sourceMappingURL=mammoth.entry.js.map